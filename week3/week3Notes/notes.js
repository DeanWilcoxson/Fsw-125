...
// current changes of the application
// stateful => it contains and knows about its own changes {persisting}
// stateless => does NOT know about its changes and does NOT keep track of any changes or anything at all really
...
// we can send req and responses as strings but if we need more complex data types like objects or arrays 
...
// resource operation = route path + HTTP method
